...
export default function IncluirApoliceJNSPage() {
        ...
        <form onSubmit={handleBuscar} className="w-full max-w-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-sm">
          <div className="p-6">
            ...
            <div className="flex flex-col gap-4">
              <Input 
                placeholder="Informe o nº da Proposta" 
                type="text"
                className="w-full text-zinc-600 dark:text-zinc-300 placeholder:text-zinc-400"
              />
